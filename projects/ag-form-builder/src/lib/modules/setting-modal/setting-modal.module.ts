...
import { InputConfigurationModule } from '../../components/input-configuration/input-configuration.module';
import { ButtonConfigurationModule } from '../../components/button-configuration/button-configuration.module';
